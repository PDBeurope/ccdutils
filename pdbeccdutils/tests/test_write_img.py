...
def test_svg_write_for_all_sample_cifs():
    for ciffile in supply_list_of_sample_cifs():
        ...
        yield assert_true, os.path.isfile(img_no_h_no_label) and os.path.getsize(img_no_h_no_label) > 0, \
            '{} call 2 to image_file_or_string(file="{}") must create a non-empty file.'.\
        ...
        yield assert_true, os.path.isfile(img_no_h_label_wedge) and os.path.getsize(img_no_h_label_wedge) > 0, \
            '{} call 3 to image_file_or_string(file="{}") must create a non-empty file.'.\
...
def test_svg_highlight_bonds():
    ...
    highlight_bonds[('C1', 'O1')] = (69./255., 117./255., 180./255.)  # C1-O1 blue
    highlight_bonds[('C1', 'C2')] = (145./255., 191./255., 219./255.)  # C1-C2 mid blue
    highlight_bonds[('C2', 'O2')] = (254./255., 224./255., 144./255.)  # C2-O2 light orange
    highlight_bonds[('C2', 'C3')] = (252./255., 141./255., 89./255.)   # C2-C3 mid orange
    highlight_bonds[('C3', 'O3')] = (215./255., 48./255., 39./255.)   # C3-O3 blood orange
    mol.image_file_or_string(file_name=this_img, hydrogen=False, atom_labels=True, wedge=False,
